\chapter{Tuning Hadoop Cluster for Best Performance}
...
\begin{itemize}
  \item Benchmarking a Hadoop cluster with GridMix in Chapter 7, Tuning a Hadoop cluster for best performance
  \item http://hadoop.apache.org/docs/r1.1.2/rumen.html
  \item https://issues.apache.org/jira/browse/MAPREDUCE-751
\end{itemize}
...
The HiBench project and the paper provide nice examples of Hadoop benchmarking. For more information, you can refer to: \verb|https://github.com/intel-hadoop/Hibench|.
\subsection*{See also}
\begin{itemize}
  \item Benchmarking and profiling a Hadoop cluster in Chapter 7, Tuning a Hadoop cluster for best performance
  \item Benchmarking a Hadoop cluster with GridMix in Chapter 7, Tuning a Hadoop cluster for best performance
  \item http://hadoop.apache.org/docs/stable/vaidya.html
\end{itemize}
...
Check the data skew through the web UI, for example, by opening URL \verb|http://master:50070/| 
...
\subsection*{How it works...} 
When speculative execution is enabled, some tasks will get killed. This can be verified by opening URL: \verb|http://master:50030/|.
