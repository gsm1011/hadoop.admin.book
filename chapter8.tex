...
Access Credentials include Access Keys\index{Access Keys}, X.509 Certificates\index{X.509 Certificates} and Key pairs\index{Key Pairs} as shown in the following screenshots:
\begin{figure}[h]
  \centering
...
Get the Access Key ID\index{Access Key ID} and the secret access key\index{secret access key} from the security credentials web page as shown in the following screenshot:
\begin{figure}[h]
  \centering
