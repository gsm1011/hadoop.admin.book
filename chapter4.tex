...
\subsection*{There's more...}
Hadoop supports access control on the queue using queue ACLs. Queue ACLs control the authorization of MapReduce job submission to a queue. More information about queue ACLs can be found at \verb|http://hadoop.apache.org/docs/r1.1.2/cluster_setup.html#Configuring+the+Hadoop+Daemons|.
...
\begin{itemize}
  ...
  \item Refer to \verb|http://hadoop.apache.org/docs/r1.1.2/capacity_scheduler.html|
\end{itemize}
...
Verify the setting of Fair Scheduler by opening the URL \verb|http://master:50030/scheduler|.
...
\begin{table}
  \begin{tabular}{lll}
    \toprule 
    Property & Value & Description \\  \midrule
